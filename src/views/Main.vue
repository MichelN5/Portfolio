...
<section id="welcome-section">
    <h1>Michel Naouss</h1>
    <h1>  Your Best Option For A Web Developer</h1>
...
<section id="projects">
    ...
    <div class="project-tile" v-for="project in projects" :key="project.id" @click="this.$router.push('project/'+ project.slug)" >
...
<section id="footer">
    ...
    <div class="social" @click="RedirectInsta">
    ...
    <div class="social" @click="RedirectGithub">
...
<div class="social" @click="RedirectWhats">
...
export default {
  ...
  methods: {
        RedirectInsta(){
            window.location.href = 'https://www.instagram.com/michel_naouss/'
        },

        RedirectGithub(){
            window.location.href = 'https://github.com/MichelN5'
        },
        RedirectWhats(){
            window.location.href = 'https://wa.me/+96178842057'
        },
